...
void gdt_init_segment(gdt_segment_t seg, unsigned long base,
...
void gdt_install() {
     ...
     *                     Conforming bit = 0 (segment is executable only from
     * ring specified) RW = 1 (Read allowed for this CS) Ac = 0 (Managed by the
     * CPU) Flags = 1100: Gr = 1 (4KiB page granularity) Sz = 1 (32-bit
     * protected mode)
     */
